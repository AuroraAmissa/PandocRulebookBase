...
\usepackage{graphicx}
\usepackage{graphbox}
\usepackage[raster, fitting, skins, breakable]{tcolorbox}
\usepackage{xcolor}

\input{_generated_pkgs}
\input{_generated_fonts}
\input{_generated_gitinfo}
...
\AddToShipoutPictureBG {%
    \IfFileExists{images/bg_\vbgimage.jp2}{%
        \includegraphics[width=\paperwidth,height=\paperheight]{images/bg_\vbgimage.jp2}%
    }{%
    }%
}
